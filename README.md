# 🇨🇳 Velocity Chinese - Automated Facebook Reels Bot

**Automated Chinese learning content generator for social media**

Generates and posts 4x daily to Facebook, Instagram, and other platforms with:
- ✅ AI-generated Chinese phrases with English translations
- ✅ Professional text-to-speech (Edge TTS)
- ✅ Beautiful gradient backgrounds with text overlays
- ✅ Perfect audio-video synchronization
- ✅ Velocity Chinese branding
...
1. Go to Actions → "Velocity Chinese - Daily 4x Upload"
...
- **Frame Rate:** 30 FPS
- **Audio:** Edge TTS (GuyNeural EN, XiaoxiaoNeural CN)
...
- English + 500ms pause + Chinese timing preserved
...
- Distinct colors: Navy (EN) / Maroon (CN) / Gray (Pinyin)
- Velocity Chinese branding on every frame
...
**Made with ❤️ for Chinese learners worldwide**

🇨🇳 Learn Chinese with Velocity Chinese! 🇨🇳
