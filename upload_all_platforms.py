...
def get_latest_reel():
    ...
    return {
        ...
        "metadata": metadata,
        "category": metadata.get("category_english", "Chinese Learning"),
...
def generate_caption(phrases, category, platform="facebook"):
    ...
    if platform == "facebook":
        ...
        for i, phrase in enumerate(phrases[:5], 0):
            ...
            caption_lines.append(f"   📍 {phrase['chinese']}")
            caption_lines.append(f"   🔊 [{phrase.get('pinyin', '')}]")
        ...
        caption_lines.extend([
            ...
            f"🔔 Follow for daily Chinese lessons!",
            f"",
            f"📖 Pinyin Guide:",
